...
export const Successtion = {
  ...
  duration: "1h 58m",
  description:
    "Many people in this world seem to be wandering along a relationship borderlining 'friends' and 'lovers'--a borderline commonly known as the FRIEND ZONE. A tricky area for those who cannot really stay friends with their close friends nor move forward to be their friends' lovers. ",
};
...
export const headerCarousel = [
  ...
  {
    poster:
      "https://streamvid.gavencreative.com/wp-content/uploads/2023/02/slider2_d.jpg",
    logo: "https://streamvid.gavencreative.com/wp-content/uploads/2023/02/skiller_img.png",
  },
];
