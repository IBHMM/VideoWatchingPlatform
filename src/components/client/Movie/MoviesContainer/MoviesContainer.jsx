...
export function MoviesContainer() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-start gap-3">
            ...
            <div className="grid 2xl:grid-cols-5 gap-4 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-3 xs:grid-cols-2 xxs:grid-cols-2 max-h-[1200px] overflow-y-scroll mt-5">
                {
