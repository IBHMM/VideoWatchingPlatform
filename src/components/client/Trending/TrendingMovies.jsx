    ...
    return (
        <Link to={`/client/home/video/${movie.id}`} className="text-white group relative">
            <span className='relative flex items-center justify-center'>
                ...
                <button 
                    className={`w-[95%] py-2 px-10 absolute bottom-[5px] bg-[rgba(255,255,255, 0.1)] backdrop-blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[14px] hover:bg-violet-500 rounded-md`}>
                    Add to My List
                </button>
            </span>
